...
ab -n 100000 -c 100 http://localhost:8080/date > test_results/get_3_servers.txt
...
# post requests
# тест с 3 серверами (через nginx)
ab -n 10000 -c 10 -p post.json -T application/json http://localhost:8080/name > test_results/post_3_servers.txt
